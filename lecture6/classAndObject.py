...
class Account:
    ...
    def debit(self, amount):
        self.balance -= amount
        print(f"Your account has been debited with Rs. {amount}. Total Amount in your account is {self.getBalance()}!!")

    def credit(self, amount):
        self.balance += amount
        print(f"Your account has been credited with Rs. {amount}. Total Amount in your account is {self.getBalance()}!!")

    def getBalance(self):
        return self.balance

accountHolder1 = Account(100000, 25041996)
